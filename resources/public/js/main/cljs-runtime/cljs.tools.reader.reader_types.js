...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_41184 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_41184(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_41185 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_41185(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41186 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41186(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41187 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41187(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41188 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41188(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41189 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41189(reader);
}
});
...
var self__ = this;
var reader__$1 = this;
var temp__5816__auto__ = self__.rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
if(cljs.core.truth_(temp__5816__auto__)){
var ch = temp__5816__auto__;
...
var temp__5816__auto__ = new cljs.core.Keyword(null,"buffer","buffer",617295198).cljs$core$IFn$_invoke$arity$1(frames);
if(cljs.core.truth_(temp__5816__auto__)){
var buffer = temp__5816__auto__;
...
var G__41208 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__41209 = s.append(c);
c = G__41208;
s = G__41209;
continue;
}
