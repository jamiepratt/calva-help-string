...
var i_33510 = (0);
while(true){
if((i_33510 < arr.length)){
(arr[i_33510] = null);

var G__33511 = (i_33510 + (1));
i_33510 = G__33511;
continue;
} else {
}
...
while(true){
var temp__5814__auto__ = (((level < x__$1.forward.length))?(x__$1.forward[level]):null);
if(cljs.core.truth_(temp__5814__auto__)){
var x_SINGLEQUOTE_ = temp__5814__auto__;
if((x_SINGLEQUOTE_.key < k)){
var G__33523 = x_SINGLEQUOTE_;
x__$1 = G__33523;
continue;
} else {
return x__$1;
...
var i_33528 = (self__.level + (1));
while(true){
if((i_33528 <= (new_level + (1)))){
(update[i_33528] = self__.header);

var G__33529 = (i_33528 + (1));
i_33528 = G__33529;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_33531 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_33531[i]));
} else {
x__$2.forward.push((((i < links_33531.length))?(links_33531[i]):null));
}

if((i < links_33531.length)){
(links_33531[i] = x__$2);
} else {
links_33531.push(x__$2);
}
...
var i_33533 = (0);
while(true){
if((i_33533 <= self__.level)){
var links_33534 = (update[i_33533]).forward;
if((x__$1 === (((i_33533 < links_33534.length))?(links_33534[i_33533]):null))){
(links_33534[i_33533] = (x__$1.forward[i_33533]));

var G__33535 = (i_33533 + (1));
i_33533 = G__33535;
continue;
} else {
var G__33536 = (i_33533 + (1));
i_33533 = G__33536;
continue;
}
} else {
