...
var clojure$core$protocols$Datafiable$datafy$dyn_33798 = (function (o){
...
var temp__5814__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.meta(o),cljs.core.with_meta(new cljs.core.Symbol("clojure.core.protocols","datafy","clojure.core.protocols/datafy",707534751,null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("cljs.analyzer","no-resolve","cljs.analyzer/no-resolve",-1872351017),true], null)));
...
return clojure$core$protocols$Datafiable$datafy$dyn_33798(o);
}
}
});
...
var clojure$core$protocols$Navigable$nav$dyn_33802 = (function (coll,k,v){
...
var temp__5814__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.meta(coll),cljs.core.with_meta(new cljs.core.Symbol("clojure.core.protocols","nav","clojure.core.protocols/nav",298936762,null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("cljs.analyzer","no-resolve","cljs.analyzer/no-resolve",-1872351017),true], null)));
if(temp__5814__auto__){
var meta_impl__5395__auto__ = temp__5814__auto__;
...
return clojure$core$protocols$Navigable$nav$dyn_33802(coll,k,v);
}
}
});
