 ...
 *   lookup refs.
 */
com.fulcrologic.fulcro.algorithms.denormalize.follow_ref = (function com$fulcrologic$fulcro$algorithms$denormalize$follow_ref(state_map,p__49321){
var vec__49322 = p__49321;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49322,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49322,(1),null);
var ref = vec__49322;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.ref_key = (function com$fulcrologic$fulcro$algorithms$denormalize$ref_key(p__49326){
var vec__49328 = p__49326;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49328,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49328,(1),null);
var ref = vec__49328;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),id)){
return table;
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (n,p__49353){
var map__49354 = p__49353;
var map__49354__$1 = cljs.core.__destructure_map(map__49354);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49354__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
var temp__5814__auto__ = (function (){var and__5043__auto__ = cljs.core.coll_QMARK_(entity);
...
com.fulcrologic.fulcro.algorithms.denormalize.add_join_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_join_BANG_(n,p__49379,entity,state_map,parent_node,idents_seen){
var map__49385 = p__49379;
var map__49385__$1 = cljs.core.__destructure_map(map__49385);
var join_node = map__49385__$1;
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49385__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49385__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
com.fulcrologic.fulcro.algorithms.denormalize.add_union_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_union_BANG_(n,p__49394,entity,state_map,idents_seen){
var map__49396 = p__49394;
var map__49396__$1 = cljs.core.__destructure_map(map__49396);
var join_node = map__49396__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49396__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var link_join_QMARK_ = com.fulcrologic.fulcro.algorithms.denormalize.lookup_ref_QMARK_(key);
...
var union_key__GT_query = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__49397){
var map__49399 = p__49397;
var map__49399__$1 = cljs.core.__destructure_map(map__49399);
var node = map__49399__$1;
var union_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49399__$1,new cljs.core.Keyword(null,"union-key","union-key",1529707234));
...
var temp__5814__auto__ = (function (){var and__5043__auto__ = com.fulcrologic.fulcro.algorithms.denormalize.lookup_ref_QMARK_(lookup_ref);
if(and__5043__auto__){
...
if(cljs.core.truth_(temp__5814__auto__)){
var e = temp__5814__auto__;
var vec__49402 = lookup_ref;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49402,(0),null);
var temp__5814__auto____$1 = (union_key__GT_query.cljs$core$IFn$_invoke$arity$1 ? union_key__GT_query.cljs$core$IFn$_invoke$arity$1(table) : union_key__GT_query.call(null,table));
if(cljs.core.truth_(temp__5814__auto____$1)){
var target_ast_node = temp__5814__auto____$1;
...
if(is_ref_QMARK_){
var temp__5814__auto__ = com.fulcrologic.fulcro.algorithms.denormalize.follow_ref(state_map,v);
if(cljs.core.truth_(temp__5814__auto__)){
var e = temp__5814__auto__;
var temp__5814__auto____$1 = (function (){var G__49406 = cljs.core.first(v);
return (union_key__GT_query.cljs$core$IFn$_invoke$arity$1 ? union_key__GT_query.cljs$core$IFn$_invoke$arity$1(G__49406) : union_key__GT_query.call(null,G__49406));
})();
if(cljs.core.truth_(temp__5814__auto____$1)){
var target_ast_node = temp__5814__auto____$1;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.denormalize = (function com$fulcrologic$fulcro$algorithms$denormalize$denormalize(p__49412,current_entity,state_map,idents_seen){
var map__49413 = p__49412;
var map__49413__$1 = cljs.core.__destructure_map(map__49413);
var top_node = map__49413__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49413__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49413__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
if(cljs.core.truth_(and__5043__auto__)){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"*","*",345799209,null),(function (){var G__49414 = nil_nodes;
var G__49414__$1 = (((G__49414 == null))?null:cljs.core.first(G__49414));
if((G__49414__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(G__49414__$1);
}
})());
} else {
return and__5043__auto__;
...
var G__49415 = result_node__$1;
var G__49415__$1 = (((G__49415 == null))?null:cljs.core.persistent_BANG_(G__49415));
if((G__49415__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__49415__$1,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var _STAR_denormalize_time_STAR__orig_val__49416 = com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_;
var _STAR_denormalize_time_STAR__temp_val__49417 = com.fulcrologic.fulcro.algorithms.denormalize.current_time();
(com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_ = _STAR_denormalize_time_STAR__temp_val__49417);

try{var ast = edn_query_language.core.query__GT_ast(query);
var G__49418 = com.fulcrologic.fulcro.algorithms.denormalize.denormalize(ast,starting_entity,state_map,cljs.core.PersistentArrayMap.EMPTY);
if((G__49418 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__49418,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
}finally {(com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_ = _STAR_denormalize_time_STAR__orig_val__49416);
}});
/**
...
var G__49419 = props;
var G__49419__$1 = (((G__49419 == null))?null:cljs.core.meta(G__49419));
if((G__49419__$1 == null)){
return null;
} else {
return new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","time","com.fulcrologic.fulcro.algorithms.denormalize/time",-375164969).cljs$core$IFn$_invoke$arity$1(G__49419__$1);
}
});
/**
...
var _STAR_root_keys_and_idents_STAR__orig_val__49420 = com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_;
var _STAR_root_keys_and_idents_STAR__temp_val__49421 = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.transient$(cljs.core.PersistentHashSet.createAsIfByAssoc([root_key_or_ident])));
(com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_ = _STAR_root_keys_and_idents_STAR__temp_val__49421);
...
}finally {(com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_ = _STAR_root_keys_and_idents_STAR__orig_val__49420);
}});
/**
...
var map__49422 = cljs.core.meta(prior_props);
var map__49422__$1 = cljs.core.__destructure_map(map__49422);
var visited = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49422__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","visited","com.fulcrologic.fulcro.algorithms.denormalize/visited",823384252));
var source_state_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49422__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","source-state-map","com.fulcrologic.fulcro.algorithms.denormalize/source-state-map",-1097808870));
