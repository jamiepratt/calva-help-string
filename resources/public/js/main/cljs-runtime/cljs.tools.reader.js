...
var G__41404 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__41404;
continue;
}
break;
...
var temp__5814__auto__ = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
if(cljs.core.truth_(temp__5814__auto__)){
var ch = temp__5814__auto__;
var temp__5814__auto____$1 = (cljs.tools.reader.dispatch_macros.cljs$core$IFn$_invoke$arity$1 ? cljs.tools.reader.dispatch_macros.cljs$core$IFn$_invoke$arity$1(ch) : cljs.tools.reader.dispatch_macros.call(null,ch));
if(cljs.core.truth_(temp__5814__auto____$1)){
var dm = temp__5814__auto____$1;
...
var G__41278 = (function (){var G__41282 = rdr;
G__41282.cljs$tools$reader$reader_types$IPushbackReader$unread$arity$2(null,ch);

return G__41282;
})();
var G__41279 = ch;
var G__41280 = opts;
var G__41281 = pending_forms;
return (cljs.tools.reader.read_tagged.cljs$core$IFn$_invoke$arity$4 ? cljs.tools.reader.read_tagged.cljs$core$IFn$_invoke$arity$4(G__41278,G__41279,G__41280,G__41281) : cljs.tools.reader.read_tagged.call(null,G__41278,G__41279,G__41280,G__41281));
}
} else {
...
if(("\\" === ch__$1)){
var ch_41405__$2 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
if((ch_41405__$2 == null)){
...
sb.append(ch_41405__$2);
} else {
}

var G__41406 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch__$1 = G__41406;
continue;
}
}
...
var vec__41285 = cljs.tools.reader.starting_line_col_info(rdr);
var start_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41285,(0),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41285,(1),null);
...
var G__41412 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(a,form);
a = G__41412;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__41288 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__41289 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__41289);

try{return cljs.tools.reader.read_delimited_internal(kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__41288);
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__41290 = cljs.tools.reader.starting_line_col_info(rdr);
var start_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41290,(0),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41290,(1),null);
var the_list = cljs.tools.reader.read_delimited(new cljs.core.Keyword(null,"list","list",765357683),")",rdr,opts,pending_forms);
var vec__41293 = cljs.tools.reader.ending_line_col_info(rdr);
var end_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41293,(0),null);
var end_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41293,(1),null);
return cljs.core.with_meta(((cljs.core.empty_QMARK_(the_list))?cljs.core.List.EMPTY:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,the_list)),(cljs.core.truth_(start_line)?cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (){var temp__5816__auto__ = cljs.tools.reader.reader_types.get_file_name(rdr);
if(cljs.core.truth_(temp__5816__auto__)){
var file = temp__5816__auto__;
...
var vec__41296 = cljs.tools.reader.starting_line_col_info(rdr);
var start_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41296,(0),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41296,(1),null);
...
var vec__41299 = cljs.tools.reader.ending_line_col_info(rdr);
var end_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41299,(0),null);
var end_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41299,(1),null);
return cljs.core.with_meta(the_vector,(cljs.core.truth_(start_line)?cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (){var temp__5816__auto__ = cljs.tools.reader.reader_types.get_file_name(rdr);
if(cljs.core.truth_(temp__5816__auto__)){
var file = temp__5816__auto__;
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"file","file",-1269645878),file], null);
} else {
...
var vec__41302 = cljs.tools.reader.starting_line_col_info(rdr);
var start_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41302,(0),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41302,(1),null);
...
var vec__41305 = cljs.tools.reader.ending_line_col_info(rdr);
var end_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41305,(0),null);
var end_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41305,(1),null);
...
var sb = (function (){var G__41308 = (new goog.string.StringBuffer());
G__41308.append(initch);
...
var G__41415 = (function (){var G__41309 = sb;
G__41309.append(ch);

return G__41309;
})();
var G__41416 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
sb = G__41415;
ch = G__41416;
continue;
}
...
switch (G__41311) {
case "\\":
var G__41419 = (function (){var G__41312 = sb;
G__41312.append(cljs.tools.reader.escape_char(sb,reader));

return G__41312;
})();
var G__41420 = reader.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
sb = G__41419;
ch = G__41420;
continue;
...
break;
default:
var G__41421 = (function (){var G__41313 = sb;
G__41313.append(ch);

return G__41313;
})();
var G__41422 = reader.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
sb = G__41421;
ch = G__41422;
continue;
...
var vec__41314 = cljs.tools.reader.ending_line_col_info(rdr);
var end_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41314,(0),null);
var end_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41314,(1),null);
...
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41317,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41317,(1),null);
...
var temp__5816__auto__ = cljs.core.find_ns(sym);
if(cljs.core.truth_(temp__5816__auto__)){
...
if((":" === token.charAt((0)))){
if((!((ns == null)))){
var temp__5814__auto__ = cljs.tools.reader.resolve_alias(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(cljs.core.subs.cljs$core$IFn$_invoke$arity$2(ns,(1))));
if(cljs.core.truth_(temp__5814__auto__)){
var ns__$1 = temp__5814__auto__;
...
var temp__5814__auto__ = cljs.core._STAR_ns_STAR_;
if(cljs.core.truth_(temp__5814__auto__)){
var ns__$1 = temp__5814__auto__;
...
var vec__41321 = cljs.tools.reader.starting_line_col_info(rdr);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41321,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41321,(1),null);
...
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41326,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41326,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta((cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5(rdr,true,null,opts,pending_forms) : cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms)));
if(cljs.core.map_QMARK_(m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata(rdr,m);
...
var vec__41331 = cljs.tools.reader.starting_line_col_info(rdr);
var start_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41331,(0),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41331,(1),null);
...
var vec__41334 = cljs.tools.reader.ending_line_col_info(rdr);
var end_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41334,(0),null);
var end_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41334,(1),null);
...
return cljs.core.with_meta(the_set,(cljs.core.truth_(start_line)?cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (){var temp__5816__auto__ = cljs.tools.reader.reader_types.get_file_name(rdr);
if(cljs.core.truth_(temp__5816__auto__)){
var file = temp__5816__auto__;
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"file","file",-1269645878),file], null);
} else {
...
var G__41337 = rdr;
(cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5(G__41337,true,null,opts,pending_forms) : cljs.tools.reader.read_STAR_.call(null,G__41337,true,null,opts,pending_forms));
...
var G__41338 = sym;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__41338)){
return Number.NaN;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__41338)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__41338)){
...
var _STAR_suppress_read_STAR__orig_val__41339 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__41340 = true;
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__41340);

try{var form = (function (){var G__41341 = rdr;
var G__41342 = false;
var G__41343 = cljs.tools.reader.READ_EOF;
var G__41344 = ")";
var G__41345 = opts;
var G__41346 = pending_forms;
return (cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$6 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$6(G__41341,G__41342,G__41343,G__41344,G__41345,G__41346) : cljs.tools.reader.read_STAR_.call(null,G__41341,G__41342,G__41343,G__41344,G__41345,G__41346));
})();
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__41339);
}});
...
var feature = (function (){var G__41347 = rdr;
var G__41348 = false;
var G__41349 = cljs.tools.reader.READ_EOF;
var G__41350 = ")";
var G__41351 = opts;
var G__41352 = pending_forms;
return (cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$6 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$6(G__41347,G__41348,G__41349,G__41350,G__41351,G__41352) : cljs.tools.reader.read_STAR_.call(null,G__41347,G__41348,G__41349,G__41350,G__41351,G__41352));
})();
...
var G__41353 = (function (){var G__41354 = rdr;
var G__41355 = false;
var G__41356 = cljs.tools.reader.READ_EOF;
var G__41357 = ")";
var G__41358 = opts;
var G__41359 = pending_forms;
return (cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$6 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$6(G__41354,G__41355,G__41356,G__41357,G__41358,G__41359) : cljs.tools.reader.read_STAR_.call(null,G__41354,G__41355,G__41356,G__41357,G__41358,G__41359));
})();
cljs.tools.reader.check_eof_error(G__41353,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond(G__41353,rdr,first_line);
...
var G__41433 = matched;
var G__41434 = cljs.tools.reader.read_suppress(first_line,rdr,opts,pending_forms);
matched = G__41433;
finished = G__41434;
continue;
} else {
...
if(cljs.core.truth_(and__5043__auto__)){
var G__41362 = new cljs.core.Keyword(null,"read-cond","read-cond",1056899244).cljs$core$IFn$_invoke$arity$1(opts);
var fexpr__41361 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"preserve","preserve",1276846509),null,new cljs.core.Keyword(null,"allow","allow",-1857325745),null], null), null);
return (fexpr__41361.cljs$core$IFn$_invoke$arity$1 ? fexpr__41361.cljs$core$IFn$_invoke$arity$1(G__41362) : fexpr__41361.call(null,G__41362));
} else {
return and__5043__auto__;
}
})())){
...
var temp__5814__auto____$1 = ((cljs.tools.reader.impl.utils.whitespace_QMARK_(ch__$1))?cljs.tools.reader.impl.commons.read_past(cljs.tools.reader.impl.utils.whitespace_QMARK_,rdr):ch__$1);
if(cljs.core.truth_(temp__5814__auto____$1)){
var ch__$2 = temp__5814__auto____$1;
...
var _STAR_suppress_read_STAR__orig_val__41363 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__41364 = (function (){var or__5045__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__41364);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__41363);
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character(rdr);
}
...
var arg_env_orig_val__41365 = cljs.tools.reader.arg_env;
var arg_env_temp_val__41366 = cljs.core.sorted_map();
(cljs.tools.reader.arg_env = arg_env_temp_val__41366);

try{var form = (function (){var G__41367 = (function (){var G__41372 = rdr;
cljs.tools.reader.reader_types.unread(G__41372,"(");
...
var G__41369 = null;
var G__41370 = opts;
var G__41371 = pending_forms;
return (cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5(G__41367,G__41368,G__41369,G__41370,G__41371) : cljs.tools.reader.read_STAR_.call(null,G__41367,G__41368,G__41369,G__41370,G__41371));
})();
...
var G__41435 = (i + (1));
var G__41436 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(args,(function (){var or__5045__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__41365);
}});
/**
...
if(cljs.core.truth_(cljs.tools.reader.arg_env)){
var temp__5814__auto__ = cljs.tools.reader.arg_env.call(null,n);
if(cljs.core.truth_(temp__5814__auto__)){
...
var temp__5814__auto__ = rdr.cljs$tools$reader$reader_types$Reader$peek_char$arity$1(null);
if(cljs.core.truth_(temp__5814__auto__)){
var ch = temp__5814__auto__;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("@",ch)){
return cljs.tools.reader.wrapping_reader(new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null))((function (){var G__41373 = rdr;
G__41373.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
...
var G__41445 = cljs.core.next(s__$1);
var G__41446 = ret;
s__$1 = G__41445;
r = G__41446;
continue;
...
var G__41447 = cljs.core.next(s);
var G__41448 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(key_vals,cljs.core.key(e)),cljs.core.val(e));
s = G__41447;
key_vals = G__41448;
continue;
} else {
...
return (new cljs.core.List(null,new cljs.core.Symbol("cljs.core","with-meta","cljs.core/with-meta",749126446,null),(new cljs.core.List(null,ret,(new cljs.core.List(null,(function (){var G__41375 = cljs.core.meta(form);
return (cljs.tools.reader.syntax_quote_STAR_.cljs$core$IFn$_invoke$arity$1 ? cljs.tools.reader.syntax_quote_STAR_.cljs$core$IFn$_invoke$arity$1(G__41375) : cljs.tools.reader.syntax_quote_STAR_.call(null,G__41375));
...
var gensym_env_orig_val__41377 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__41378 = cljs.core.PersistentArrayMap.EMPTY;
(cljs.tools.reader.gensym_env = gensym_env_temp_val__41378);
...
}finally {(cljs.tools.reader.gensym_env = gensym_env_orig_val__41377);
}});
cljs.tools.reader.read_namespaced_map = (function cljs$tools$reader$read_namespaced_map(rdr,_,opts,pending_forms){
var vec__41379 = cljs.tools.reader.starting_line_col_info(rdr);
var start_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41379,(0),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41379,(1),null);
...
var temp__5814__auto__ = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(token,":"))?cljs.core.ns_name(cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(":",cljs.core.first(token)))?(function (){var G__41382 = token;
var G__41382__$1 = (((G__41382 == null))?null:cljs.core.subs.cljs$core$IFn$_invoke$arity$2(G__41382,(1)));
var G__41382__$2 = (((G__41382__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol(G__41382__$1));
var G__41382__$3 = (((G__41382__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_(G__41382__$2));
var G__41382__$4 = (((G__41382__$3 == null))?null:cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(G__41382__$3));
if((G__41382__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns(G__41382__$4);
}
})():(function (){var G__41383 = token;
var G__41383__$1 = (((G__41383 == null))?null:cljs.tools.reader.impl.commons.parse_symbol(G__41383));
if((G__41383__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_(G__41383__$1);
}
})()
));
if(cljs.core.truth_(temp__5814__auto__)){
var ns = temp__5814__auto__;
...
var vec__41384 = cljs.tools.reader.ending_line_col_info(rdr);
var end_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41384,(0),null);
var end_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41384,(1),null);
...
return cljs.core.with_meta(cljs.core.zipmap(keys,vals),(cljs.core.truth_(start_line)?cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (){var temp__5816__auto__ = cljs.tools.reader.reader_types.get_file_name(rdr);
if(cljs.core.truth_(temp__5816__auto__)){
var file = temp__5816__auto__;
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"file","file",-1269645878),file], null);
} else {
...
var temp__5814__auto__ = (function (){var or__5045__auto__ = cljs.tools.reader._STAR_data_readers_STAR_.call(null,tag);
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
if(cljs.core.truth_(temp__5814__auto__)){
var f = temp__5814__auto__;
var G__41389 = (cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5(rdr,true,null,opts,pending_forms) : cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__41389) : f.call(null,G__41389));
} else {
var temp__5814__auto____$1 = cljs.tools.reader._STAR_default_data_reader_fn_STAR_;
if(cljs.core.truth_(temp__5814__auto____$1)){
var f = temp__5814__auto____$1;
var G__41390 = tag;
var G__41391 = (cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5 ? cljs.tools.reader.read_STAR_.cljs$core$IFn$_invoke$arity$5(rdr,true,null,opts,pending_forms) : cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__41390,G__41391) : f.call(null,G__41390,G__41391));
} else {
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__41397,reader){
var map__41398 = p__41397;
var map__41398__$1 = cljs.core.__destructure_map(map__41398);
var opts = map__41398__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__41398__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
